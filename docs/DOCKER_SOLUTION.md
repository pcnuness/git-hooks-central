...
Solução utiliza **Docker** para garantir que os hooks Git funcionem consistentemente em qualquer ambiente de desenvolvimento (Mac, Linux, Windows), eliminando problemas de dependências e compatibilidade.
...
- **SAST**: Verificar solução com o cliente
- **Secret Detection**: GitLeaks (Go),
...
│                    CATÁLOGO CENTRAL                         │
│  ┌─────────────────┐    ┌─────────────────┐                 │
│  │.pre-commit-hooks│    │docker/Dockerfile│                 │
│  └─────────────────┘    └─────────────────┘                 │
└─────────────────────────────────────────────────────────────┘
                              │
                              ▼
...
│  │  • SAST - Verificar soluções utilizadas             │    │
│  │  • Secret Detection (Secrets)                       │    │
│  │  • Dependence Scanning (dependency_scanning)        │    │
│  │  • Node.js + npm/yarn/pnpm                          │    │
│  │  • Java + Maven/Gradle                              │    │
│  └─────────────────────────────────────────────────────┘    │
└─────────────────────────────────────────────────────────────┘
